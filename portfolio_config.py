...
PORTFOLIO = [
    ...
    {"code": "2884", "name": "玉山金", "market": "TWSE", "shares": 21000, "cost_per_share": 28.5, "valuation_method": "yield", "payout_ratio": 0.66, "target_yields": {"cheap": 5.0, "fair": 4.0, "target": 3.0}},
    # ⚠️ 【修正】富邦金：已調整為佔位數字，請依據真實對帳單將 60.0 與 1000 更改為正確的成本與股數
    {"code": "2881", "name": "富邦金", "market": "TWSE", "shares": 100000, "cost_per_share": 50.0, "valuation_method": "yield", "payout_ratio": 0.5, "target_yields": {"cheap": 5.0, "fair": 4.0, "target": 3.0}},
    ...
    {"code": "2451", "name": "創見", "market": "TWSE", "shares": 1200 "cost_per_share": 150.0, "valuation_method": "yield", "payout_ratio": 0.90, "target_yields": {"cheap": 7.0, "fair": 6.0, "target": 5.0}},
